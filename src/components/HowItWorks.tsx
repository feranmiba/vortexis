    ...
    <div className=" max-w-6xl mx-auto p-6 bg-white">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div className=" lg:mt-8 space-y-4">
          ...
          <div className="flex">
            <div className="mr-4">
              <Image src={icon4} alt="icon4" className="text-white w-18 " />
            </div>
            <div>
              <h3 className="font-medium text-gray-800 text-lg">All-In-One Platform</h3>
          ...
          <div className="flex">
            <div className="mr-4">
              <Image src={icon3} alt="icon3" className="text-white w-18" />
            </div>
            <div>
              <h3 className="font-medium text-gray-800 text-lg">Team Collaboration</h3>
              <p className="text-md text-gray-600">
          ...
          <div className="flex">
            <div className="mr-4">
              <Image src={icon2} alt="icon2" className="text-white w-18" />
            </div>
            <div>
              <h3 className="font-medium text-gray-800 text-lg">Real-Time Analytics</h3>
              <p className="text-md text-gray-600">
          ...
          <div className="flex">
            <div className="mr-4">
              <Image src={icon1} alt="icon1" className="text-white w-18" />
            </div>
            <div>
              <h3 className="font-medium text-gray-800 text-lg">Built For Devs</h3>
              <p className="text-md text-gray-600">
