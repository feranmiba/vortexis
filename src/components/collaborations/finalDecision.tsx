...
<div className="flex gap-4 items-center">
      <p className="bg-[#727272] px-1 h-6 text-center py-0.5 rounded-full text-xs">Rank#1</p>
...
<div className="mb-2 flex items-center justify-between">
  <div className="flex justify-between w-[408px]"> <p>Jane Doe</p> <p>9.4</p></div>
  <div className="flex justify-between w-[565px]"> <p>Maria Rodriguez</p> <p>8.5</p></div>
</div>
<div className="mb-2 flex items-center justify-between">
  <div className="flex justify-between w-[408px]"> <p>Alex Smith</p> <p>8.4</p></div>
</div>
<div className="mb-2 flex items-center justify-between">
  <div className="flex justify-between w-[408px]"> <p>Maria Rodriguez</p> <p>8.5</p></div>
</div>

<div className="w-[627px] mt-3">
  <p className="text-2xl mb-1">Summary Comments</p>
  <p>Innovative solution with strong technical implementation. UI could use some polish.</p>
</div>
