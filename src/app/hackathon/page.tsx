...
const Page: React.FC = () => {
  ...
  const [filteredHackathons, setFilteredHackathons] = useState<Hackathon[]>(hackathonsData);
    ...
    <section>
      ...
      <section className="flex justify-between px-5 lg:px-10 flex-wrap  lg:flex-nowrap gap-10 py-5 md:py-10">
        ...
        <section className="lg:w-[30%] lg:space-y-10 flex flex-wrap gap-2 lg:block md:gap-10">
          ...
          <FilterSection title="Interest Type" options={Hackathons} selectedOption={selectedHackathons} onChange={setSelectedHackathons} />
        </section>
